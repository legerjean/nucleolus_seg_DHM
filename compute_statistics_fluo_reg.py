...
def compute_features(directory, gfp_virtual_annotations_filename, en_interleaved):
    manual_mode = True

    # Data cleaning
    dapi_virtual_annotations = np.load('/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/filter_mask_uint8.npy')
    gfp_virtual_annotations = np.load(gfp_virtual_annotations_filename)
    if en_interleaved:
        gfp_virtual_annotations = gfp_virtual_annotations[0::4]
    labels_nucleoli_manual_improved = np.load('/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/filter_mask_uint8.npy')
    ...
    #
    dapi_virtual_annotations_clean = dapi_virtual_annotations[1:25]
    gfp_virtual_annotations_clean = gfp_virtual_annotations[1:25]
    labels_nucleoli_manual_improved_wo_border = labels_nucleoli_manual_improved[1:25]
    gfp_virtual_annotations_manual = gfp_virtual_annotations[1:25]
    ...
    phase_images = phase_images[1:25]
    gfp_images = np.load('./samples/images_gfp_shifted_0.npy')
    gfp_images = gfp_images[1:25]
...
def plot_confusion_matrices(folder):
    ...
    entry_true = np.load('./statistics/regularization_manual/nb_nucleoli.npy')
    ...
    sn.heatmap(df_cm, annot=True, annot_kws={"size": 14}, cmap='Purples', fmt='d', xticklabels=x_axis_labels,
    ...
    plt.subplot(1,2,2)
    sn.heatmap(df_cm_n, annot=True, annot_kws={"size": 14}, cmap='Purples', xticklabels=x_axis_labels,
               yticklabels=y_axis_labels)  # font size
    plt.ylabel(r'Manual annotations', fontsize=14)
    plt.xlabel(r'Automatic predictions', fontsize=14)
...
# Manual
folder_name1 = 'regularization_DL_augm_weighted_sat100'
#compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/labels_nucleoli_manual_shifted_0.npy')
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy/results/model_unet_2d_weighted_n_layers_5_modality_interleaved_weighted_woif_sat100/firstval0/predictions.npy', 1)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_DL_augm_weighted_sat100', './statistics/regularization_DL_augm_weighted_sat100')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')


# Deep learning thresholding
folder_name1 = 'regularization_DL_thr008'
#compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/labels_nucleoli_manual_shifted_0.npy')
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy/results/model_unet_2d_n_layers_5_modality_thr008/firstval0/predictions.npy', 0)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_DL_thr008', './statistics/regularization_DL_thr008')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')

folder_name1 = 'regularization_DL_thr010'
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy/results/model_unet_2d_n_layers_5_modality_thr010/firstval0/predictions.npy', 0)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_DL_thr010', './statistics/regularization_DL_thr010')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')

folder_name1 = 'regularization_DL_thr012'
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy/results/model_unet_2d_n_layers_5_modality_thr012/firstval0/predictions.npy', 0)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_DL_thr012', './statistics/regularization_DL_thr012')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')

folder_name1 = 'regularization_DL_thr014'
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy/results/model_unet_2d_n_layers_5_modality_thr014/firstval0/predictions.npy', 0)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_DL_thr014', './statistics/regularization_DL_thr014')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')


# Thresholding
folder_name1 = 'regularization_thr008'
#compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/labels_nucleoli_manual_shifted_0.npy')
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/thr_008_close_25_first_filtered.npy', 0)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_thr008', './statistics/regularization_thr008')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')

folder_name1 = 'regularization_thr010'
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/thr_010_close_25_first_filtered.npy', 0)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_thr010', './statistics/regularization_thr010')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')

folder_name1 = 'regularization_thr012'
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/thr_012_close_25_first_filtered.npy', 0)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_thr012', './statistics/regularization_thr012')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')

folder_name1 = 'regularization_thr014'
compute_features(folder_name1, '/export/home/jleger/Documents/segmentation/microscopy_regularization/samples/thr_014_close_25_first_filtered.npy', 0)
remove_zeros(folder_name1, './statistics/' + folder_name1 + '/')
intra_population_statistics('./statistics/' + folder_name1 + '/')
plot_details_histograms('./statistics/regularization_thr014', './statistics/regularization_thr014')
plot_confusion_matrices('./statistics/' + folder_name1 + '/')
